# MUBS Drug & Alcohol Awareness Platform

## Project Overview

A comprehensive web-based platform designed to create awareness about drug and alcohol abuse among students at Makerere University Business School (MUBS). The system provides educational content, self-assessment tools, counseling services, community forums, and incident reporting in a safe, accessible, and stigma-free environment.
...
composer create-project laravel/laravel mubs-awareness-platform

# Navigate into project
cd mubs-awareness-platform
...
CREATE DATABASE mubs_awareness CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```
...
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=mubs_awareness
DB_USERNAME=root
DB_PASSWORD=your_password

# Application settings
APP_NAME="MUBS Awareness Platform"
APP_ENV=local
APP_DEBUG=true
...
CREATE DATABASE mubs_awareness_test;

# Update phpunit.xml
<env name="DB_CONNECTION" value="mysql"/>
<env name="DB_DATABASE" value="mubs_awareness_test"/>
```
...
# Database backup
mysqldump -u username -p mubs_awareness > backup.sql
