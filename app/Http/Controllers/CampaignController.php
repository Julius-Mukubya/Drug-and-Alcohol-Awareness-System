    ...
    public function sample($slug)
    {
        $sampleCampaigns = [
            'mindful-mubs-week' => [
                ...
                'target_audience' => 'All MUBS students, especially those experiencing academic stress, anxiety, or looking to improve their mental wellness. No prior experience with mindfulness required - beginners are welcome!',
                'timeline' => [
                    [
            ...
            'sober-socials-kickoff' => [
                ...
                'target_audience' => 'All MUBS students who want to socialize in an alcohol-free environment. Perfect for those in recovery, those who choose not to drink, or anyone looking for alternative social activities.',
                'timeline' => [
                    [
                        'title' => 'Event Setup',
            ...
            'stress-less-live-more' => [
                ...
                'participants' => 95,
                'duration' => 7,
                'goals' => 'To equip students with practical stress management tools, improve academic performance through better stress handling, and promote overall mental health and wellbeing across the MUBS community.',
