...
@section('title', 'Create Account - MUBS D&A Awareness Platform')
                ...
                <div class="w-full lg:w-1/2 max-w-md">
                    <div class="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-2xl border border-gray-200 dark:border-gray-700">
                        <div class="text-center mb-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mt-2">Join the MUBS community</p>
                        </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Connect with fellow MUBS students who understand your journey and challenges.</p>
                </div>
            </div>
        </div>
    </div>
