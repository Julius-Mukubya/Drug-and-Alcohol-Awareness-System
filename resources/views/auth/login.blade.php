...
@section('title', 'Sign In - MUBS D&A Awareness Platform')
    ...
    <div class="w-full bg-background-light dark:bg-background-dark py-16">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Access personalized features designed to support your wellbeing journey at MUBS.</p>
            </div>
