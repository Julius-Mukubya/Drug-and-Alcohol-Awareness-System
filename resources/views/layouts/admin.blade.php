...
<head>
    ...
    <title>@yield('title', 'MUBS Awareness - Admin Dashboard')</title>
            ...
            <div class="flex h-full flex-col justify-between p-4">
                <div class="flex flex-col gap-4">
                    ...
                    <nav class="flex flex-col gap-2 mt-4">
                        ...
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.quizzes.*') ? 'bg-primary/20 dark:bg-primary/30' : 'hover:bg-gray-100 dark:hover:bg-white/10' }}" href="{{ route('admin.quizzes.index') }}">
                            <span class="material-symbols-outlined {{ request()->routeIs('admin.quizzes.*') ? 'text-primary' : 'text-gray-700 dark:text-gray-300' }}">quiz</span>
                            <p class="{{ request()->routeIs('admin.quizzes.*') ? 'text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300' }} text-sm font-medium leading-normal">Quizzes</p>
                        </a>
                        ...
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('counselor.sessions.*') ? 'bg-primary/20 dark:bg-primary/30' : 'hover:bg-gray-100 dark:hover:bg-white/10' }}" href="{{ route('counselor.sessions.index') }}">
                            ...
                            <p class="{{ request()->routeIs('counselor.sessions.*') ? 'text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300' }} text-sm font-medium leading-normal">Counseling</p>
                        </a>
                        <a class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.incidents.*') ? 'bg-primary/20 dark:bg-primary/30' : 'hover:bg-gray-100 dark:hover:bg-white/10' }}" href="{{ route('admin.incidents.index') }}">
                            <span class="material-symbols-outlined {{ request()->routeIs('admin.incidents.*') ? 'text-primary' : 'text-gray-700 dark:text-gray-300' }}">report</span>
                            <p class="{{ request()->routeIs('admin.incidents.*') ? 'text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-300' }} text-sm font-medium leading-normal">Incidents</p>
                        </a>
