...
@section('title', $sampleCampaign['title'] . ' - MUBS Wellness Hub')
            ...
            <div class="max-w-4xl">
                ...
                <div class="flex flex-col sm:flex-row gap-6 text-white/80">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="font-medium">By MUBS Wellness Team</span>
                    </div>
                </div>
            </div>
        </div>
...
function shareToTwitter() {
    const text = encodeURIComponent('Check out this sample campaign from MUBS Wellness Hub - {{ $sampleCampaign["title"] }}');
