...
@section('title', 'Dr. Sarah Rodriguez - Counselor Profile - MUBS Wellness Hub')
...
<div class="bg-gray-50 dark:bg-gray-900 py-4">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex items-center gap-2 text-sm">
            <a href="{{ route('public.home') }}" class="text-gray-500 dark:text-gray-400 hover:text-primary transition-colors">Home</a>
            <span class="material-symbols-outlined text-gray-400 text-sm">chevron_right</span>
            <a href="{{ route('public.counseling.index') }}" class="text-gray-500 dark:text-gray-400 hover:text-primary transition-colors">Counseling</a>
            <span class="material-symbols-outlined text-gray-400 text-sm">chevron_right</span>
            <span class="text-gray-900 dark:text-white font-medium">Dr. Sarah Rodriguez</span>
        </nav>
    </div>
</div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        @auth
                            @if(auth()->user()->role === 'student')
                                <a href="{{ route('student.counseling.create') }}?counselor=sarah-rodriguez" class="bg-white text-blue-600 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/90 transition-all shadow-xl">
...
<section id="availability" class="py-20 bg-white dark:bg-gray-800">
        ...
        <div class="text-center">
            <div class="bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 rounded-3xl p-8 text-white">
                ...
                <p class="text-blue-100 text-sm mt-4">
                    All counseling services are free for MUBS students
                </p>
            </div>
        </div>
    </div>
