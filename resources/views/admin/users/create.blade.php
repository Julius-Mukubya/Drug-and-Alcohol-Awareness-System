...
<div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-center gap-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
                    <div class="relative">
                        <div class="w-24 h-24 rounded-full bg-gradient-to-br from-primary to-blue-600 flex items-center justify-center overflow-hidden ring-4 ring-white dark:ring-gray-800">
                            <span class="material-symbols-outlined text-4xl text-white" id="avatar_icon">person</span>
        ...
        <div class="flex gap-3 mt-8">
            <button type="submit" class="bg-primary text-white px-8 py-3 rounded-lg hover:opacity-90 font-semibold">Create User</button>
