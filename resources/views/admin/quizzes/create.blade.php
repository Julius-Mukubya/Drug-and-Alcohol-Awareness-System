...
@section('content')
<div class="mb-6">
    <a href="{{ route('admin.quizzes.index') }}" class="text-primary hover:underline flex items-center gap-1">
...
<div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create New Quiz</h2>
